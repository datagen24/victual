...
S16's body-schema-validation half, still parked behind
[14](plans/14-contract-and-regression-scaffolding.md) piece 2 for the reason given in its
own row. See S11's own row for what shipped and how it was verified.
