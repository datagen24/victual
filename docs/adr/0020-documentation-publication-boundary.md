...
`config-dist.php`. All of it is read on GitHub. [Plan 26](../plans/26-documentation-site.md)
...
building per tag. [Plan 26](../plans/26-documentation-site.md) owns the build, the
