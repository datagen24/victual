...
| [0025](0025-three-test-tiers.md) | Three test tiers: PHPUnit against a real PostgreSQL, pgTAP for the SQL logic, probes for the browser | **Proposed** 2026-09-17, five spike prerequisites | [issue 192](https://github.com/datagen24/victual/issues/192), [14](../plans/14-contract-and-regression-scaffolding.md) piece 2 |
