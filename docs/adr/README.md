...
| 0020 | Proposed, recorded 2026-09-07 and not assessed by the 2026-09-04 gate review. Four acceptance prerequisites: PR 92 landed, plan 26 handling the 173 ADR-to-plan links, the PHP API reference question answered, and the manual verified to stand alone. Plan 26 piece 1 supplies the build evidence; acceptance is tracked in [issue 135](https://github.com/datagen24/victual/issues/135). Note that accepting it makes every later ADR a published document. |
