...
| [0019](0019-label-printers-are-master-data.md) | Label printers are master data; a separate worker pulls print jobs over an authenticated API | **Proposed**, supplies the configuration, transport and ownership split [0011](0011-label-namespace.md) item 4 left open; relies on 0010; items 1-5 reconciled against [0021](0021-label-templates-are-application-data.md) 2026-09-07, **which must be accepted first**; gates 2-5 met, gate 1 open on the interpreter question; two format-dependent details outstanding before acceptance | [22](../plans/22-medication-tracking.md) Q6 (unowned by it), [20](../plans/20-container-infrastructure.md) piece 5 |
...
| [0021](0021-label-templates-are-application-data.md) | Label templates are application data, a reprint is a new job over retained bytes, and an import refuses live labels | **Proposed**, **supersedes three boundaries of [0011](0011-label-namespace.md)**; six acceptance prerequisites; **accepted before [0019](0019-label-printers-are-master-data.md)** | [27](../plans/27-label-templates-and-rendering.md), [25](../plans/25-label-infrastructure.md) |
