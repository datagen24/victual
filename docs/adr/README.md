...
| [0020](0020-documentation-publication-boundary.md) | The documentation site publishes the manual, the developer reference and the ADRs; plans stay in the repository | **Accepted** 2026-09-14, all four prerequisites met; **every ADR written from here on is a published document** | [26](../plans/26-documentation-site.md) Q1 |
...
| [0022](0022-open-containers-carry-a-measured-remainder.md) | An opened container's remaining contents are measured on the stock entry, not derived from the product | **Accepted** 2026-09-14, all eight prerequisites met | [28](../plans/28-open-container-measurement.md), [29](../plans/29-working-container-replenishment.md) |
| [0023](0023-taxonomy-is-groups-packaging-is-parent-product.md) | Taxonomy lives in product groups; `parent_product_id` means packaging and stays one level deep | **Accepted** 2026-09-14, all four prerequisites met; **answers [plan 07 question 6](https://github.com/datagen24/victual/issues/82)** — plan 07's retirement is separate, later work, not performed by this acceptance | [30](../plans/30-nested-product-groups.md), [31](../plans/31-directed-substitution.md), [07](../plans/07-nested-products.md) |
| [0024](0024-the-fork-writes-its-own-clients.md) | The fork writes its own clients; the five `/printlabel` endpoints move to the label subsystem | **Accepted** 2026-09-15, its one prerequisite met; **supersedes in part** [0019](0019-label-printers-are-master-data.md) decision item 7's gate on step 2 | [32](../plans/32-label-kinds.md), [17](../plans/17-ecosystem-clients.md), [25](../plans/25-label-infrastructure.md) |
| [0025](0025-three-test-tiers.md) | Three test tiers: PHPUnit against a real PostgreSQL, pgTAP for the SQL logic, probes for the browser | **Accepted** 2026-09-17, all five spike prerequisites met ([`.spike-adr25/RESULTS.md`](../../.spike-adr25/RESULTS.md)); the completeness check is proven but not yet gating CI | [issue 192](https://github.com/datagen24/victual/issues/192), [14](../plans/14-contract-and-regression-scaffolding.md) piece 2 |
