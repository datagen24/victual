...
| 0022 | Proposed, recorded 2026-09-09. Eight acceptance prerequisites cover coexistence, conversions, compaction, wire compatibility, container identity, undo and the legacy tare decision. Questions 2–5 have review recommendations; question 1 remains an acceptance gate and question 6 needs catalogue evidence. Plan 28 owns implementation. |
| 0023 | Proposed, recorded 2026-09-13. Decided from a deliberate sampling of the real catalogue rather than from the code, which is what question 6 required — seven of thirteen candidate pairs were separate products and none was a pool, so the relation `parent_product_id` exists to express had nothing in the catalogue to act on. Retires plan 07 rather than shrinking it. Four acceptance prerequisites; prerequisite 1 asks that the sampling itself be recorded in plan 07 so the evidence is inspectable. Note open question 1: whether a group minimum rolls up to descendant groups touches a view plan 03 already shipped. |
