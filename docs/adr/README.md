...
| [0022](0022-open-containers-carry-a-measured-remainder.md) | An opened container's remaining contents are measured on the stock entry, not derived from the product | **Proposed**, five acceptance prerequisites | [28](../plans/28-open-container-measurement.md) |
...
| 0022 | Proposed, recorded 2026-09-09. Eight acceptance prerequisites cover coexistence, conversions, compaction, wire compatibility, container identity, undo and the legacy tare decision; none is met, and prerequisite 4 as written needs plan 14 piece 2's snapshot, which does not exist yet. Questions 2–5 have review recommendations; question 1 remains an acceptance gate and question 6 needs catalogue evidence. Plan 28 owns implementation; the acceptance work is [issue 129](https://github.com/datagen24/victual/issues/129). |
