...
| [0024](0024-the-fork-writes-its-own-clients.md) | The fork writes its own clients; the five `/printlabel` endpoints move to the label subsystem | **Proposed** 2026-09-15; **supersedes in part** [0019](0019-label-printers-are-master-data.md) decision item 7's gate on step 2 | [32](../plans/32-label-kinds.md), [17](../plans/17-ecosystem-clients.md), [25](../plans/25-label-infrastructure.md) |
