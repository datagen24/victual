...
| [0023](0023-taxonomy-is-groups-packaging-is-parent-product.md) | Taxonomy lives in product groups; `parent_product_id` means packaging and stays one level deep | **Proposed**, four acceptance prerequisites; **answers [plan 07 question 6](https://github.com/datagen24/victual/issues/82) and retires that plan** | [30](../plans/30-nested-product-groups.md), [31](../plans/31-directed-substitution.md), [07](../plans/07-nested-products.md) |
...
| 0023 | Proposed, recorded 2026-09-13. Decided from a deliberate sampling of the real catalogue rather than from the code, which is what question 6 required — seven of thirteen candidate pairs were separate products and none was a pool, so the relation `parent_product_id` exists to express had nothing in the catalogue to act on. Retires plan 07 rather than shrinking it. Four acceptance prerequisites; prerequisite 1, the sampling recorded in plan 07, was met 2026-09-14; 2–4 are tracked in [issue 128](https://github.com/datagen24/victual/issues/128). Note open question 1: whether a group minimum rolls up to descendant groups touches a view plan 03 already shipped. |
