...
- **Migration numbering.** Two files, claiming **0281** (medication master data and subjects)
  ...
  follow-up — took 0280 ahead of this plan —, with rows added to
  ...
  [08](08-nested-locations.md), then 0279–0280 for issue 148's fix, and now 0280–0281 for
  issue 130 — so
  ...
  issue 130 to plan 11's own follow-up also being written, so
  this plan's numbers have four times moved for work that was closer to having a file than
  this one is.
