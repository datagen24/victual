...
[ADR-0020](../adr/0020-documentation-publication-boundary.md), accepted 2026-09-14 — piece 1
was built first deliberately, because two of that record's four acceptance prerequisites ask
for evidence only a working build can supply, and it supplied it.
