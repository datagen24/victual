...
| 4 | 08 nested locations; 23 storage classes; 28 and 29; 30 and 31, the product hierarchy 07-Q6 chose | **08 complete, 2026-09-09. 23 complete, 2026-09-14** — `storage_classes`, `locations.storage_class_id`, migration `0274.pgsql.php`; see its [Executed](23-storage-classes.md#executed) section. **28 complete, 2026-09-14** — migration `0275.pgsql.sql`; see its [Executed](28-open-container-measurement.md#executed) section. **29 complete, migration `0276.pgsql.sql`** — see its own [Executed](29-working-container-replenishment.md#executed) section; its weighing half was unblocked once 28 landed on the tables 23 prepared. **ADR-0023 accepted 2026-09-14 and [07](07-nested-products.md) retired the same day**, so [30](30-nested-product-groups.md), [issue 124](https://github.com/datagen24/victual/issues/124), and then [31](31-directed-substitution.md), [issue 125](https://github.com/datagen24/victual/issues/125), were scheduled. **30 landed 2026-09-15** — migration `0278.pgsql.sql`; see its [Executed](30-nested-product-groups.md#executed) section. **31 landed 2026-09-15** — migration `0279.pgsql.sql`; see its own [Executed](31-directed-substitution.md#executed) section. Migrations were renumbered on scheduling — 28 landed at 0275, 29 landed at 0276, 148's fix at 0277, 30 landed at 0278, 31 landed at 0279, unscheduled 22 at 0280–0281. Order within the wave: 23, 28, 29, 30 and 31, all landed. **Wave 4 is complete** except for unscheduled plan 22. 28 and 31 wanted to land before 14 piece 2 freezes the contract — both have. |
