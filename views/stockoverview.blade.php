...
@include('components.label_print_list_header', ['idPrefix' => 'stockoverview'])
						...
						<div class="dropdown d-inline-block">
							...
							<div class="table-inline-menu dropdown-menu dropdown-menu-right">
								...
								<a class="dropdown-item product-label-print"
									data-target-id="{{ $currentStockEntry->product_id }}"
									data-target-name="{{ $currentStockEntry->product_name }}"
									type="button"
									href="#">
									{{ $__t('Print a label for this product') }}
								</a>
								@endif
							</div>
						</div>
