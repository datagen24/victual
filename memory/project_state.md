...
- **Wave 5 opened 2026-09-15**: 19 piece 2 landed as `0281.pgsql.sql` (#170); its four open
  ...
  (label tree path), #169 (undo self-production). Review follow-ups still open: #177 (files
  ...
  is unblocked now that #130 and #121 are closed. **Next unclaimed migration number: 0285** —
  0282 went to #176 and plan 22's two claimed-unwritten numbers moved up to 0283–0284, per
  `migrations/RESERVATIONS.md`'s own "claims without files behind them yield" rule.
