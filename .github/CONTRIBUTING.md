...
[0004](../docs/adr/0004-engine-specific-migrations.md). Those two records are the test
for whether a decision belongs in an ADR: a decision that constrains later work,
