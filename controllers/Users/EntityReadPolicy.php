...
class EntityReadPolicy
{
	const PERMISSIONS = [
		...
		'product_substitutions' => User::PERMISSION_STOCK_VIEW,
		'product_substitutions_resolved' => User::PERMISSION_STOCK_VIEW,
		...
		'product_groups_resolved' => User::PERMISSION_STOCK_VIEW,
