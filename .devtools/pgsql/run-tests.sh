...
#
#   .devtools/pgsql/run-tests.sh [migrate|views|triggers|rollback|filter|schema|richtext|files|mqtt|import|rbac|chores|errors|average|groupminstock|locations|openmeasure|workingcontainer]
#
# Seventeen kinds of check, for seventeen reasons. Views are compared by what they return, because
